...
namespace POIProxy
{
    public class POISessionRegistery
    {
        ...
        public void RegisterSession(POIUser user, int sessionId)
        {
            ...
            {
                Console.WriteLine("No such session exists!");
            }
        }
        ...
        public void RemoveSession(POIUser user)
        {
            if (sessionUserRegistery.ContainsKey(user))
            {
                ...
                {
                    Console.WriteLine("No session associated with such session id");
                }
                ...
                {
                    Console.WriteLine("No session associated with such content id");
                }
            ...
            {
                Console.WriteLine("No session associated with the user");
            }
        }
    }
}
